    ...
    <section className="w-full py-16 mb-16 bg-white" id="about">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between px-4 lg:gap-20 gap-12">
        ...
        <div className="lg:w-1/2">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-black font-opensans leading-tight mb-6">
            Chop Chop <br /> Fresh Quality Meat
          </h2>
          <p className="text-gray-600 text-base font-commissioner mb-8 leading-relaxed text-justify">
        ...
        Since 2018, Chop Chop has been committed to delivering fresh, clean, and safe meat right to your doorstep.
          ...
          <div className="flex flex-col gap-4 mb-8">
            <div className="flex items-center gap-3 text-[#9c0202]">
          ...
          {/* Button */}
          <button className="group relative overflow-hidden bg-[#9c0202] text-white px-6 py-3 rounded-full flex items-center gap-3 font-semibold transition-all duration-300 hover:scale-105 hover:shadow-xl">
  <span className="transition-all duration-300 group-hover:-translate-x-1">Read more</span>
